...
var apiUrls = {
	root: process.env.GITHUB_ENTERPRISE_URL ? (process.env.GITHUB_ENTERPRISE_URL + '/api/v3/') : 'https://api.github.com',
	user: 'user',
	orgs: 'users/%s/orgs',
...
module.exports = {
	...
	events: function (token) {
		return makeRequest(url.resolve(apiUrls.root, apiUrls.events), token);
	},
